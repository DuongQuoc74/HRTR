CREATE TABLE [dbo].[GC_AnalysisData_Processing] (
    ...
    [GC_AnalysisData_ProcessingID] INT            IDENTITY (1, 1) NOT NULL
);


GO
CREATE CLUSTERED INDEX [IX_GC_AnalysisData_Processing]
    ON [dbo].[GC_AnalysisData_Processing]([Analysis_ID] ASC, [Customer_ID] ASC);
