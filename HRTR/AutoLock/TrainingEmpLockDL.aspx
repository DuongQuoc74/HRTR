<%@ Page Title="Training Employee Lock DL" Language="C#" MasterPageFile="~/HCM.Master"
    AutoEventWireup="true" CodeBehind="TrainingEmpLockDL.aspx.cs" Inherits="HRTR.AutoLock.TrainingEmpLockDL" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="maincontent">
    <div id="divMainContent" style="height: 100%">
        <div class="MainContainHeader">
            Training Employee Lock DL</div>
                                            ...
                                            <tr>
                                                <td>
                                                    <table>
                                                        <tr>
                                                            <td style="width: 10%">
                                                                <asp:Button ID="btnUploadAsk" runat="server" Text="Upload" CssClass="button" OnClientClick="return UploadTrainingEmpLockValidation();">
                                                                </asp:Button>
                                                            </td>
                                                            <td>
                        ...
                        <tr>
                            <td>
                                <ajaxToolkit:ModalPopupExtender ID="mpeTrainingEmpLock" runat="server" TargetControlID="btnNewTrainingEmpLock"
                                    ...
                                    BehaviorID="bhvmpeTrainingEmpLock" Enabled="True" OnOkScript="btnReturnTrainingEmpLock">
                                ...
                                <asp:Panel CssClass="modalPopupCommon" Style="display: none; width: 600px;" ID="pnTrainingEmpLockPopup"
                                    ...
                                    <asp:Panel CssClass="modalPopupDrag" ID="pnEmployeePopupDrag" runat="server">
                                        <div>
                                            <p>
                                                Add/ Update/ Delete Training Emp Lock Record</p>
                                        </div>
                                    </asp:Panel>
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="2" style="text-align: center;">
                                                    ...
                                                    <asp:Button ID="btnUpdateAsk" runat="server" Text="Update" CssClass="button" UseSubmitBehavior="False"
                                                        ValidationGroup="vgtrainingemplock" OnClientClick="return TrainingEmpLockUpdateValidation();">
                                                    </asp:Button>
