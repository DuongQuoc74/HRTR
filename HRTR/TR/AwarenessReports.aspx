<%@ Page Title="" Language="C#" MasterPageFile="~/HCM.Master" AutoEventWireup="true" CodeBehind="AwarenessReports.aspx.cs" Inherits="HRTR.TR.AwarenessReports" %>
    ...
    <div id="divMainContent" style="height: 100%">
        ...
        <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" CombineScripts="True"
            ...
            <Scripts>
                ...
                <asp:ScriptReference Path="../Scripts/AwarenessReports.js"></asp:ScriptReference>
            </Scripts>
                ...
                <table>
                    <tbody>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:DropDownList ID="ddlTrainingGroup" runat="server" AppendDataBoundItems="True" Width="99%"
                                                            DataTextField="TrainingGroupName" DataValueField="TrainingGroupID" AutoPostBack="True"
                                                    ...
                                                    <td>
                                                        <asp:Label ID="Label4" runat="server" Text="Course Group"></asp:Label>
                                                         <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="cv_ClientValidate"
                                                            ControlToValidate="ddlCourseGroup" ErrorMessage="Course Group is required."
                                                            ValidationGroup="vgsearch">(*)</asp:CustomValidator>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <asp:DropDownList ID="ddlCourseGroup" runat="server" AppendDataBoundItems="True" Width="99%"
                                                            DataTextField="CourseGroupName" DataValueField="CourseGroupID" AutoPostBack="True"
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:DropDownList ID="ddlCourse" runat="server" AppendDataBoundItems="True" Width="99%"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="white-space: nowrap;">
                                                        <asp:DropDownList ID="ddlOutputType" runat="server" Width="99%">
                                                            <asp:ListItem Value="1" Text="Excel File" />
                                                            <asp:ListItem Value="2" Text="Column Chart" />
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td>
                        ...
                        <tr>
                            <td>
                                <center>
                                    <asp:Chart ID="chartColumnChart_AwarenessRecord" runat="server" Width="750px" Height="400px" Visible="false">
                                ...
                                <br />
                                <asp:GridView ID="grvAwarenessRecord" runat="server" AllowPaging="True" AllowSorting="True"
                                    ShowHeaderWhenEmpty="true" AutoGenerateColumns="True"
                                    OnPageIndexChanging="grvAwarenessRecord_PageIndexChanging"
                                    OnRowDataBound="grvAwarenessRecord_RowDataBound" OnSorting="grvAwarenessRecord_Sorting"
