// JScript File
jQuery.noConflict();
var GrapeChart1, GrapeChart2, GrapeChart3, GrapeChart4;
...
function RefreshAll() {
    ...
    //    alert('RefreshAll');
    //    jQuery('[id$="lblGrapeChart"]').html("Grape Chart is loading.");
    ...
    if (IsIE()) {
        ...
        RefreshGrapeChart("3");
        RefreshGrapeChart("4");
        //        GrapeChart1 = setInterval("RefreshGrapeChart('swfGrapeChart1', 'lblEmployeeName1', 'lblMonthYear1', '1');", 2000);
        //        GrapeChart2 = setInterval("RefreshGrapeChart('swfGrapeChart2', 'lblEmployeeName2', 'lblMonthYear2', '2');", 2000);
        //        GrapeChart2 = setInterval(RefreshGrapeChart("swfGrapeChart2", "lblEmployeeName2", "lblMonthYear2", "2"), 2000);
        //        GrapeChart2 = setInterval(RefreshGrapeChart("swfGrapeChart2", "lblEmployeeName2", "lblMonthYear2", "2"), 2000);
    }
    else {
...
function RefreshGrapeChart(GrapeChartID) {
    ...
    if (grapecharttypeid == "1") {
        grapecharttype = "Defect Escapee";
    }
    else {
        grapecharttype = "Defect Finder";
    }
    ...
    strurl = "../AjaxServer/ASGrapeChart.aspx?type=10&employeeid_id=" + employeeid_id
        + "&t=" + grapecharttypeid
        + "&year=" + year
        + "&month=" + month
        + "&w=" + customer_id + "";
