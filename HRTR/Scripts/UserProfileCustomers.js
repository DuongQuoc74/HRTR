...
function RemoveUserFromRole(userprofileid, username, rolename) {
    ...
    if (lblRemoveMessage != null)
        lblRemoveMessage.innerHTML = "Are you sure you want to remove user " + username + " from customer " + rolename + "?";
...
function AddValidation() {
    ...
    if (Page_ClientValidate('vgaddusertorole')) {
        ...
        var vCustomersNameA = "";
        var ddlCustomersA = document.getElementById("ctl00_maincontent_ddlCustomersA");
        if (ddlCustomersA != null)
            vCustomersNameA = ddlCustomersA.options[ddlCustomersA.selectedIndex].text;

        var lblAddMessage = document.getElementById("ctl00_maincontent_lblAddMessage");
        if (lblAddMessage != null)
            lblAddMessage.innerHTML = "Are you sure you want to add user " + vUserNameA + " to customer " + vCustomersNameA + "?";
