<%@ Page Title="Permission Role/ User Profile" Language="C#" MasterPageFile="~/HCM.Master"
    AutoEventWireup="true" CodeBehind="UserProfilePermissionRole.aspx.cs" Inherits="SystemAuth.UserManagement.UserProfilePermissionRole" %>
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <fieldset>
                                    <legend>Add User Profile To Pemission Role</legend>
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td style="width: 10%;">
